...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'lua', 'markdown', 'markdown_inline', 'python', 'ruby', 'vimdoc', 'vim', 'go' },
  ...
  -- For ruby, every time a dot '.' is typed, Treesitter unconditionally dedents (de-indents).
